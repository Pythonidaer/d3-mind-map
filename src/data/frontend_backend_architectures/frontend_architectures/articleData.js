const articleData = {
    ...
    keyPrinciples: [
      'Optimize rendering performance for faster user experiences.',
      'Separate concerns between data, logic, view, and state clearly.',
      'Design flexible systems that evolve gracefully as requirements grow.',
      'Minimize client-side load through smart loading and rendering strategies.',
      'Build reusable, composable UI components and modules.',
    ],
