const articleData = {
  ...
  principle1: {
    ...
    content: [
      'A well-architected backend separates logic, data access, and transport layers to avoid coupling between responsibilities.',
      'This improves maintainability, testing, and flexibility when modifying one part of the system without affecting others.',
    ],
  },
  ...
  principle2: {
    ...
    content: [
      'Architect for vertical (bigger machines), horizontal (more instances), and geographic (multiple regions) scaling.',
      'Choose strategies based on expected load, deployment constraints, and latency sensitivity.',
    ],
  },
  ...
  principle3: {
    ...
    content: [
      'Incorporate timeouts, retries, fallbacks, and circuit breakers to handle partial failures gracefully.',
      'Distributed systems must assume failures and provide recovery strategies at every layer.',
    ],
  },
  ...
  principle4: {
    ...
    content: [
      'Understand the tradeoffs between strong consistency and eventual consistency.',
      'Some systems prioritize immediate accuracy; others prefer availability and partition tolerance under the CAP theorem.',
    ],
  },
  ...
  principle5: {
    ...
    content: [
      'Backend logic should reflect real-world business processes using clean, consistent models.',
      'Domain-driven design promotes long-term alignment between code and user needs.',
    ],
  },
