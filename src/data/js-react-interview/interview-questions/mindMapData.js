...
export const nodes = [
    ...
    // React Concepts
    { id: 'stateVsProps', label: 'State vs\nProps', definition: 'Compare and contrast data flow and control.', shape: 'rect', color: 'mintGreen' },
    { id: 'hooksUsage', label: 'useState /\nuseEffect /\nuseContext', definition: 'Common usage, dependencies, side effects.', shape: 'rect', color: 'mintGreen' },
    { id: 'renderingTypes', label: 'Rendering\nTypes', definition: 'Explain client, server, static rendering differences.', shape: 'rect', color: 'mintGreen' },
  
    // JavaScript Concepts
    { id: 'closureScope', label: 'Closures &\nScope', definition: 'Lexical scope and retained references.', shape: 'rect', color: 'mintGreen' },
    { id: 'asyncAwait', label: 'Async/Await &\nPromises', definition: 'How promises and async functions work.', shape: 'rect', color: 'mintGreen' },
    { id: 'arrayDestructuring', label: 'Array & Object\nDestructuring', definition: 'Use cases for spread/rest and unpacking data.', shape: 'rect', color: 'mintGreen' },
  
    // Coding Challenges
    { id: 'todoFilter', label: 'Todo List /\nFilter', definition: 'Build and filter lists with state and user input.', shape: 'rect', color: 'mintGreen' },
    { id: 'formValidation', label: 'Form\nValidation', definition: 'Controlled components with error handling.', shape: 'rect', color: 'mintGreen' },
    { id: 'mockFetch', label: 'Mock Fetch &\nDisplay', definition: 'Simulate fetch/async logic, loading, and display states.', shape: 'rect', color: 'mintGreen' },
  
    // Performance & Testing
    { id: 'memoization', label: 'Memoization /\nRe-renders', definition: 'Prevent unnecessary renders using memo/hooks.', shape: 'rect', color: 'mintGreen' },
    { id: 'testingTypes', label: 'Unit vs\nIntegration\nTesting', definition: 'When to use which, and testing libraries.', shape: 'rect', color: 'mintGreen' },
  
    // Architecture & Behavioral
    { id: 'componentSplit', label: 'Component\nSplitting', definition: 'How to refactor components for readability.', shape: 'rect', color: 'mintGreen' },
    { id: 'tellMeTime', label: 'Tell Me About\nA Time When...', definition: 'Behavioral questions on ownership, conflict, delivery, etc.', shape: 'rect', color: 'mintGreen' }
  ];
