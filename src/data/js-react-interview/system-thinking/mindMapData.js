...
export const nodes = [
    ...
    // Subtopics
    { id: 'perceivedPerformance', label: 'Perceived\nPerformance', definition: 'How fast the experience feels to the user, even before full content loads.', shape: 'rect', color: 'nodePositive2' },
    { id: 'accessibility', label: 'Accessibility', definition: 'Ensure no change introduces keyboard, screen reader, or contrast regressions.', shape: 'rect', color: 'nodePositive2' },
  
    { id: 'codeOwnership', label: 'Code\nOwnership', definition: 'Clarify who maintains shared files, modules, or APIs.', shape: 'rect', color: 'nodePositive2' },
    { id: 'reviewLoad', label: 'Review\nLoad', definition: 'Avoid pull requests that are too large, rushed, or opaque to reviewers.', shape: 'rect', color: 'nodePositive2' },
  
    { id: 'semanticVersioning', label: 'Semantic\nVersioning', definition: 'Update major, minor, and patch versions with care.', shape: 'rect', color: 'nodePositive2' },
    { id: 'thirdParty', label: 'Third-Party\nDependencies', definition: 'Understand the cost, size, risk, and compatibility of added packages.', shape: 'rect', color: 'nodePositive2' },
  
    { id: 'stateIsolation', label: 'State\nIsolation', definition: 'Avoid lifting state too high or sharing it unnecessarily across modules.', shape: 'rect', color: 'nodePositive2' },
    { id: 'modularBoundaries', label: 'Modular\nBoundaries', definition: 'Encapsulate functionality with clear input/output contracts.', shape: 'rect', color: 'nodePositive2' },
  
    { id: 'logEvents', label: 'Event\nLogging', definition: 'Track actions that lead to outcomes or bugs in production.', shape: 'rect', color: 'nodePositive2' },
    { id: 'errorReporting', label: 'Error\nReporting', definition: 'Use tools like Sentry to monitor real-time issues.', shape: 'rect', color: 'nodePositive2' },
  
    { id: 'fallbacks', label: 'UI\nFallbacks', definition: 'Use loading spinners, error states, and skeletons to gracefully degrade.', shape: 'rect', color: 'nodePositive2' },
    { id: 'timeoutHandling', label: 'Timeout /\nRetry Logic', definition: 'Gracefully retry or timeout requests to avoid user frustration.', shape: 'rect', color: 'nodePositive2' }
  ];
